...
# data = Winsorizer(capping_method='iqr', tail='both', fold=1.5, variables=['Open', 'Close', 'Low', 'High',
#                                                                         'prev_close','Volume'])
# df=data.fit_transform(df)

# xtrain, xtest, ytrain, ytest = train_test_split(df[['Open', 'High', 'Low', 'prev_close','Volume']], df['Close'], test_size=0.3,
